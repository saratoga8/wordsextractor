package free.wordsextractor.common.tests;
...
public abstract class Utils {
    ...
    public static Shells getShell() {
        String osName = System.getProperty("os.name");
        if (osName == null) {
            throw new InvalidParameterException("Can't detect the OS' name");
        }
        ...
        if (osName.contains("windows")) {
            ...
            throw new InvalidParameterException("Unknown OS' name " + osName);
    }
    ...
    public static String getResourcePathStr(Object obj, String fileName) throws URISyntaxException {
        ...
        if (path == null)
            throw new InvalidParameterException("Can't found the resource file " + fileName);
